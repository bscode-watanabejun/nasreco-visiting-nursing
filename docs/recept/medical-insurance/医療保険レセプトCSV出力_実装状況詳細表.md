...
| 4 | 訪問した場所1文字データ | - | ❌ 未実装 | 空欄（入力画面未実装） |
| 5 | 訪問した場所2訪問場所変更年月日 | - | ❌ 未実装 | 空欄（訪問場所変更履歴入力画面未実装） |
| 6 | 訪問した場所2コード | - | ❌ 未実装 | 空欄（訪問場所変更履歴入力画面未実装） |
| 7 | 訪問した場所2文字データ | - | ❌ 未実装 | 空欄（訪問場所変更履歴入力画面未実装） |
| 8 | 訪問した場所3訪問場所変更年月日 | - | ❌ 未実装 | 空欄（訪問場所変更履歴入力画面未実装） |
| 9 | 訪問した場所3コード | - | ❌ 未実装 | 空欄（訪問場所変更履歴入力画面未実装） |
| 10 | 訪問した場所3文字データ | - | ❌ 未実装 | 空欄（訪問場所変更履歴入力画面未実装） |
| 11 | 訪問終了年月日 | - | ❌ 未実装 | 空欄（**患者管理画面**に「訪問終了年月日」入力項目未実装） |
| 12 | 訪問終了時刻 | - | ❌ 未実装 | 空欄（**患者管理画面**に「訪問終了時刻」入力項目未実装） |
| 13 | 訪問終了状況コード | - | ❌ 未実装 | 空欄（**患者管理画面**に「訪問終了状況コード」入力項目未実装） |
| 14 | 訪問終了状況文字データ | - | ❌ 未実装 | 空欄（**患者管理画面**に「訪問終了状況文字データ」入力項目未実装） |
| 15 | 死亡年月日 | - | ✅ 実装済み | **患者管理画面**「死亡年月日」 |
| 16 | 死亡時刻 | - | ❌ 未実装 | 空欄（**患者管理画面**に「死亡時刻」入力項目未実装） |
| 17 | 死亡場所コード | - | ❌ 未実装 | 空欄（**患者管理画面**に「死亡場所コード」入力項目未実装） |
| 18 | 死亡場所文字データ | - | ❌ 未実装 | 空欄（**患者管理画面**に「死亡場所文字データ」入力項目未実装） |
