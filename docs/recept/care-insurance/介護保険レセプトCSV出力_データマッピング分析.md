...
**必須項目の出力可否**: 
- ✅ 出力可能: 約40項目
- ⚠️ 要確認（推測実装済み）: 2項目（居宅介護支援事業所番号、公費給付率）
...
| 7111 | 12 | 12 | 0 | 0 |
| 7131基本情報（01） | 約20項目 | 約20項目 | 2項目（居宅介護支援事業所番号、公費給付率） | 1項目（中止理由コードはデータなし） |
...
**必須項目の約90%は出力可能**です。残りの10%については、デフォルト値の設定や仮値の設定により対応可能です。
