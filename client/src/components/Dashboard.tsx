    ...
    <div className="space-y-6 p-6">
      ...
      <Tabs defaultValue="visits" className="space-y-4">
        <TabsList className="grid w-full grid-cols-3">
          <TabsTrigger value="visits">本日の訪問</TabsTrigger>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center gap-3 p-3 border rounded-lg border-destructive/20 bg-destructive/5">
                  <AlertTriangle className="h-4 w-4 text-destructive" />
                  <div>
                    <p className="font-medium">薬物投与エラーの可能性</p>
                    <p className="text-sm text-muted-foreground">佐藤太郎さん - 薬物重複チェックが必要</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 border rounded-lg border-destructive/20 bg-destructive/5">
                  <AlertTriangle className="h-4 w-4 text-destructive" />
                  <div>
                    <p className="font-medium">バイタルサイン異常</p>
                    <p className="text-sm text-muted-foreground">鈴木花子さん - 血圧值が基準値を超過</p>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
                    <p className="font-medium">佐藤太郎さん</p>
                    <p className="text-sm text-muted-foreground">2024/09/25 09:00 - 定期訪問</p>
                  </div>
                  <Badge className={getStatusColor('completed')}>完了</Badge>
                </div>
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
                    <p className="font-medium">田中明さん</p>
                    <p className="text-sm text-muted-foreground">2024/09/24 14:30 - アセスメント</p>
                  </div>
                  <Badge className={getStatusColor('completed')}>完了</Badge>
                </div>
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
                    <p className="font-medium">伊藤みどりさん</p>
                    <p className="text-sm text-muted-foreground">2024/09/24 10:15 - 定期訪問</p>
                  </div>
                  <Badge className={getStatusColor('completed')}>完了</Badge>
                </div>
              </div>
